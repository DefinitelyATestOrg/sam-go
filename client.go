...
// DefaultClientOptions read from the environment (API_KEY, SAM_BASE_URL). This
// should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("SAM_BASE_URL"); ok {
...
// environment (API_KEY, SAM_BASE_URL). The option passed in as arguments are
